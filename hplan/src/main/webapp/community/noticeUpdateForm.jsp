...
<div align="center" id="com_title">
	...
	<a id="community_font2" href="#">REVIEW Q/A</a> 
</div>
<hr>
&nbsp;&nbsp;&nbsp;
...
<div class="mb-3">
  <label for="writer" class="form-label">글번호</label>
  <input type="text" class="form-control" id="num" name ="num" value="${dto.num}" readonly="readonly" style="background-color: gray;">
</div>
<div class="mb-3">
  <label for="writer" class="form-label">작성자</label>
  <input type="text" class="form-control" id="writer" name ="writer"placeholder="HPALN" value="${dto.writer}">
</div>
<div class="mb-3">
...
<button type="button" id="btnUpdate" class="btn btn-dark" >수정하기</button>
...
$(function() {
	$("#btnUpdate").click(function() {
		...
		document.form1.action="${path}/notice_servlet/btnUpdate.do";
